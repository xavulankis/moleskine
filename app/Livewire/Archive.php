...
class Archive extends Component
{
    ...
    {
        $this->dateFrom = date('Y-m-d', strtotime(Entry::onlyTrashed()->where('user_id', Auth::id())->min('entries.date')));
        $this->initialDateFrom = date('Y-m-d', strtotime(Entry::onlyTrashed()->where('user_id', Auth::id())->min('entries.date')));
        $this->dateTo = date('Y-m-d', strtotime(Entry::onlyTrashed()->where('user_id', Auth::id())->max('entries.date')));
        $this->initialDateTo = date('Y-m-d', strtotime(Entry::onlyTrashed()->where('user_id', Auth::id())->max('entries.date')));        
    }   
