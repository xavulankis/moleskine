            ...
            <div class="mx-auto w-11/12 mt-4 pb-4 rounded-sm flex flex-col gap-2">
                ...
                <div class="flex flex-col md:flex-row gap-2">
                    ...
                    <div class="flex flex-row justify-start items-center w-full">
                        <span class="w-full p-2">{{$entry->id}}</span>
                    </div>
                ...
                <div class="flex flex-col md:flex-row gap-2">
                    ...
                    <div class="flex flex-row justify-start items-center p-0 w-full">
                        <input wire:model="date" name="date" id="date" type="date" value="{{ old('date') }}"
                                    maxlength="200"
                                    class="w-fit rounded-sm bg-zinc-100 border-1 border-zinc-300 text-gray-900 p-2 focus:border-black focus:outline-hidden focus:ring-green-400 focus:border-green-400">
                    </div>
                ...
                <div class="flex flex-col md:flex-row gap-2">
                    ...
                    <div class="flex flex-row justify-start items-center p-0 w-full">
                        <input wire:model="title" name="title" id="title" type="text" value="{{ old('title') }}"
                                    maxlength="200"
                                    class="w-full rounded-sm bg-zinc-100 border-1 border-zinc-300 text-gray-900 p-2 focus:border-black focus:outline-hidden focus:ring-green-400 focus:border-green-400">
                    </div>
                ...
                <div class="flex flex-col md:flex-row gap-2">
                    ...
                    <div class="flex flex-row justify-start items-center w-full">
                        <select wire:model.live="category_id" name="category_id" id="category_id"
                            class="w-full md:w-fit rounded-sm bg-zinc-100 border-1 border-zinc-300 text-gray-900 p-2 focus:border-black focus:outline-hidden focus:ring-green-400 focus:border-green-400">
