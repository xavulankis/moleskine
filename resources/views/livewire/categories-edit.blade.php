<div class="w-full sm:max-w-10/12 mx-auto">
    ...
    <div class="flex flex-row justify-start items-start gap-1 py-1 text-sm text-slate-600">
        ...
        <a href="/categories/show/{{$category->id}}" class="hover:text-amber-600">Info</a> /
        <a href="/categories/edit/{{ $category->id }}" class="font-bold text-black border-b-2 border-b-green-600">Edit</a>
    </div>
